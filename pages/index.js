    ...
    <div>
        ...
        <div className={styles.Main}>
            ...
            <p>
                ...
                Originally I wanted to use React, but I learned that React is a library and not a framework so I decided to use Next.js instead because it uses React applications.
            </p>
            ...
            <p>
                ...
                Then, I used the Git terminal to bootstrap Vercel's example blog Next.js app to my computer.
                After that, I was able to run the run dev command and see the web pages on my localhost:3000 address.
            </p>

            <p className={styles.Info2}>Building the Web Page</p>

            <p>
                During the course of this semester, I was able to create the HTML and CSS template I use for every lab.
                For each lab I usually change the colour palette and the content of the web page.
                ...
                For the titles, headings, and layout I was able to learn the JavaScript used to add styles to the elements.
